...
public class TuringCompleteRecipeProvider extends FabricRecipeProvider {
    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup registryLookup, RecipeExporter exporter) {
        return new RecipeGenerator(registryLookup, exporter) {
            ...
            public void generate() {
                createShaped(RecipeCategory.BUILDING_BLOCKS, blockInit.LOGIC_BASE_PLATE_BLOCK, 12)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.NAND_GATE, 3)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.NOT_GATE, 2)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.AND_GATE, 1)
                .input('N', blockInit.NAND_GATE)
                .input('R', Blocks.REDSTONE_WIRE)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.OR_GATE, 1)
                .input('N', blockInit.NAND_GATE)
                .input('R', Blocks.REDSTONE_WIRE)
                .input('G', blockInit.NOT_GATE)
                .pattern("GR ")
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.NOR_GATE, 1)
                .input('N', blockInit.NAND_GATE)
                .input('R', Blocks.REDSTONE_WIRE)
                .input('G', blockInit.NOT_GATE)
                .pattern("GR ")
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.XOR_GATE, 1)
                .input('N', blockInit.NAND_GATE)
                .input('R', Blocks.REDSTONE_WIRE)
                .pattern(" N ")
                .pattern("NRN")
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.XNOR_GATE, 1)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.THREE_AND_GATE, 1)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.THREE_OR_GATE, 1)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.SWITCH_GATE, 1)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.MEMORY_CELL, 1)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.HALF_ADDER, 1)
                .input('X', blockInit.XOR_GATE)
                .input('A', blockInit.AND_GATE)
                .input('W', Blocks.REDSTONE_WIRE)
                .pattern("WW ")
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.FULL_ADDER, 1)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.BI_DIRECTIONAL_REDSTONE_BRIDGE_BLOCK, 1)
                .input('R', Blocks.REPEATER)
                .input('W', Blocks.REDSTONE_WIRE)
                .pattern(" W ")
                .pattern("WRW")
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.OMNI_DIRECTIONAL_REDSTONE_BRIDGE_BLOCK, 1)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.SR_LATCH_BLOCK, 1)
                .input('R', Blocks.REDSTONE_WIRE)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.JK_LATCH_BLOCK, 1)
                ...
                createShaped(RecipeCategory.REDSTONE, blockInit.T_LATCH_BLOCK, 1)
                .input('W', Blocks.REDSTONE_WIRE)
    ...
    public String getName() {
        return "TuringCompleteRecipeProvider";
    }
}
